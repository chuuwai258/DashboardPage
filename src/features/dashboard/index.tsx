...
import ChartBarMultiple from '#/features/dashboard/components/BarChart'
import ChartLineDefault from '#/features/dashboard/components/LineChart'
import ChartPieLegend from '#/features/dashboard/components/ExpensePieChart'
        ...
        <div className=" px-7 md:px-10 lg:px-15   lg:py-5 lg:pb-10">
          <div className="flex flex-col md:flex-row lg:flex-row  md:gap-8 lg:gap-10 items-stretch">
            ...
            <div className="md:w-[40%] lg:w-[40%]">
              <h1 className="text-xl mb-5 lg:mb-5 text-primary2 font-semibold">
                Quick Transfer
              </h1>
            ...
            <div className="w-full md:w-[57%] lg:w-[80%]">
              <h1 className="text-xl mb-5 mt-4 md:mt-0 lg:mt-0 lg:mb-5 text-primary2 font-semibold">
                Balance History
              </h1>
