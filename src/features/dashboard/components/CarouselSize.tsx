      ...
      >
        ...
        <div className="flex md:flex-col lg:flex-row md:gap-4 items-center justify-between px-5 mt-4 ">
          ...
          <div className="flex items-center relative">
            <input
              type="text"
              className="bg-[#EDF1F7] w-[180px] lg:w-[265px] h-[30px] lg:h-[50px] rounded-full px-4 lg:px-7 text-base lg:text-lg"
              placeholder="525.50"
            />
            <button>
              <img
                src={Images.send}
                alt=""
                className="absolute -top-8 lg:-top-12 -right-4 lg:-right-9 size-25 lg:size-38"
              />
            </button>
          </div>
        </div>
